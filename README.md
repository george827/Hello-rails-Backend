...
```sh
  git clone https://github.com/george827/Hello-rails-Backend.git
...
Feel free to check the [issues page](https://github.com/george827/Hello-rails-Backend/issues).
...
This project is [MIT](https://github.com/george827/Hello-rails-Backend/blob/dev/LICENSE) licensed.
